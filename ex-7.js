...
// Start coding here
let isArray = Array.isArray(orders); //console.log(isArray);

orders[2].creditCardType = "visa";
let creditCardTypeOfBlindermann = orders[2].creditCardType; //console.log(creditCardTypeOfBlindermann);

let productQuantityOfJoannet = orders[3].productQuantity; //console.log(productQuantityOfJoannet);
let totalPurchaseOfDary = (orders[1].productPrice) * (orders[1].productQuantity); //console.log(totalPurchaseOfDary);
